...
import net.destiny.destinyloc.procedures.CryptSecurityburotukugapureyaniPoHuaisaretatokiProcedure;
...
public class CryptSecurityBlock extends DestinyLocModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crypt_security");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Use Server Only"));
		}
