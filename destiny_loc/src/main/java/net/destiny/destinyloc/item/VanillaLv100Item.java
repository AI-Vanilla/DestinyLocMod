...
import net.destiny.destinyloc.entity.renderer.VanillaLv100Renderer;
...
public class VanillaLv100Item extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:vanilla_lv_100")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("vanilla_lv_100");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.6f, 64, 3);
