...
import net.destiny.destinyloc.entity.renderer.VanillaLv50Renderer;
...
public class VanillaLv50Item extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:vanilla_lv_50")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletvanilla_lv_50").setRegistryName("entitybulletvanilla_lv_50");

	public VanillaLv50Item(DestinyLocModElements instance) {
		super(instance, 37);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VanillaLv50Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.6f, 20, 3);
