...
public class Candy2021Item extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:candy_2021")
	public static final Item block = null;
	public Candy2021Item(DestinyLocModElements instance) {
		super(instance, 124);
	}
