...
import net.destiny.destinyloc.entity.renderer.HalfdanDRenderer;
import net.destiny.destinyloc.DestinyLocModElements;

import java.util.Random;

@DestinyLocModElements.ModElement.Tag
public class HalfdanDItem extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:halfdan_d")
