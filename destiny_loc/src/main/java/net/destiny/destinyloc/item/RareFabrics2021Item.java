...
public class RareFabrics2021Item extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:rare_fabrics_2021")
	public static final Item block = null;

	public RareFabrics2021Item(DestinyLocModElements instance) {
		super(instance, 150);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("rare_fabrics_2021");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Preparing to Celebrate Hope."));
		}
	}
}
