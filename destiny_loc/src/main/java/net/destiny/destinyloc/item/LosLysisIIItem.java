...
import net.destiny.destinyloc.entity.renderer.LosLysisIIRenderer;
import net.destiny.destinyloc.DestinyLocModElements;

import java.util.Random;

@DestinyLocModElements.ModElement.Tag
public class LosLysisIIItem extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:ros_lysis_ii")
