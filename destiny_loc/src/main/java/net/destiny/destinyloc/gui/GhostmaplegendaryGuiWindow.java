...
@OnlyIn(Dist.CLIENT)
public class GhostmaplegendaryGuiWindow extends ContainerScreen<GhostmaplegendaryGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = GhostmaplegendaryGui.guistate;
	public GhostmaplegendaryGuiWindow(GhostmaplegendaryGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("destiny_loc:textures/ghostmaplegendary.png");
	@Override
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "LEGENDARY", 177, 21, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 72, this.guiTop + 3, 50, 20, new StringTextComponent("Quest"), e -> {
			if (true) {
				DestinyLocMod.PACKET_HANDLER.sendToServer(new GhostmaplegendaryGui.ButtonPressedMessage(0, x, y, z));
				GhostmaplegendaryGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 305, this.guiTop + 3, 55, 20, new StringTextComponent("Season"), e -> {
			if (true) {
				DestinyLocMod.PACKET_HANDLER.sendToServer(new GhostmaplegendaryGui.ButtonPressedMessage(1, x, y, z));
				GhostmaplegendaryGui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
