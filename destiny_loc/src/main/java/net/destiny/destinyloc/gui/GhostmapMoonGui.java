...
import net.destiny.destinyloc.procedures.TPMoonProcedure;
...
public class GhostmapMoonGui extends DestinyLocModElements.ModElement {
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 3) {
			...
			TPMoonProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
