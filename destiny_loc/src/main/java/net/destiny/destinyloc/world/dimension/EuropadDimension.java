...
import net.destiny.destinyloc.item.EuropadItem;
...
public class EuropadDimension extends DestinyLocModElements.ModElement {
	@ObjectHolder("destiny_loc:europad_portal")
	public static final CustomPortalBlock portal = null;

	public EuropadDimension(DestinyLocModElements instance) {
		super(instance, 24);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("destiny_loc:europad"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("europad_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("europad_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("europad_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new EuropadItem().setRegistryName("europad"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("destiny_loc:europad"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("destiny_loc:europad")));
				} else {
					entity.func_242279_ag();
