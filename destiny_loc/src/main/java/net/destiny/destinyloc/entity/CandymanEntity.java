...
import net.destiny.destinyloc.procedures.Drop_candyProcedure;
import net.destiny.destinyloc.itemgroup.DestinyLoCItemGroup;
import net.destiny.destinyloc.item.TheCandyItem;
import net.destiny.destinyloc.entity.renderer.CandymanRenderer;
...
public class CandymanEntity extends DestinyLocModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.1f, 2.3000000000000003f)).build("candyman").setRegistryName("candyman");
	public CandymanEntity(DestinyLocModElements instance) {
		super(instance, 126);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CandymanRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DestinyLoCItemGroup.tab)).setRegistryName("candyman_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 10, 1, 5));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 100;
			setNoAI(false);
			setCustomName(new StringTextComponent("[Lv1] Candy man"));
			setCustomNameVisible(true);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(TheCandyItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(TheCandyItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Blocks.MAGMA_BLOCK));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TheCandyItem.block));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				Drop_candyProcedure.executeProcedure($_dependencies);
			}
		}
