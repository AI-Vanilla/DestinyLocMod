...
import net.destiny.destinyloc.item.CommonFabrics2021Item;
import net.destiny.destinyloc.entity.renderer.CookiemanRenderer;
import net.destiny.destinyloc.DestinyLocModElements;

@DestinyLocModElements.ModElement.Tag
public class CookiemanEntity extends DestinyLocModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("cookieman").setRegistryName("cookieman");

	public CookiemanEntity(DestinyLocModElements instance) {
		super(instance, 169);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CookiemanRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DestinyLoCItemGroup.tab)).setRegistryName("cookieman_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 1;
			setNoAI(false);
			setCustomName(new StringTextComponent("[Lv1] Cookie man"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CommonFabrics2021Item.block));
		}
