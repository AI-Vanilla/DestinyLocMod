...
import net.destiny.destinyloc.item.LegendaryFabrics2021Item;
import net.destiny.destinyloc.entity.renderer.CookieMan3Renderer;
import net.destiny.destinyloc.DestinyLocModElements;

@DestinyLocModElements.ModElement.Tag
public class CookieMan3Entity extends DestinyLocModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("cookie_man_3").setRegistryName("cookie_man_3");

	public CookieMan3Entity(DestinyLocModElements instance) {
		super(instance, 171);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CookieMan3Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DestinyLoCItemGroup.tab))
				.setRegistryName("cookie_man_3_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 20;
			setNoAI(false);
			setCustomName(new StringTextComponent("[Lv50] Cookie man"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(LegendaryFabrics2021Item.block));
		}
