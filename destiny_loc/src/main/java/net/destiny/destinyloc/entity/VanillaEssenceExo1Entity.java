...
import net.destiny.destinyloc.procedures.VanillaEssenceExo2enteiteigaSiWangsitaShiProcedure;
import net.destiny.destinyloc.procedures.VanillaEssenceExo1enteiteigasuponsitaShiProcedure;
import net.destiny.destinyloc.itemgroup.DestinyLoCItemGroup;
import net.destiny.destinyloc.entity.renderer.VanillaEssenceExo1Renderer;
...
public class VanillaEssenceExo1Entity extends DestinyLocModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.1f, 2.6f)).build("vanilla_essence_exo_1").setRegistryName("vanilla_essence_exo_1");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletvanilla_essence_exo_1").setRegistryName("entitybulletvanilla_essence_exo_1");

	public VanillaEssenceExo1Entity(DestinyLocModElements instance) {
		super(instance, 84);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VanillaEssenceExo1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65485, -1, new Item.Properties().group(DestinyLoCItemGroup.tab))
				.setRegistryName("vanilla_essence_exo_1_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Items.DRAGON_HEAD));
		...
		public void onDeath(DamageSource source) {
			...
			VanillaEssenceExo2enteiteigaSiWangsitaShiProcedure
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			VanillaEssenceExo1enteiteigasuponsitaShiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			return retval;
		}
