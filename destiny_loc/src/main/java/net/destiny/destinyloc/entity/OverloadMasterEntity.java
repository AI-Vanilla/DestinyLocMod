...
import net.destiny.destinyloc.entity.renderer.OverloadMasterRenderer;
...
public class OverloadMasterEntity extends DestinyLocModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 2.2f))
					.build("overload_master").setRegistryName("overload_master");

	public OverloadMasterEntity(DestinyLocModElements instance) {
		super(instance, 131);
		FMLJavaModLoadingContext.get().getModEventBus().register(new OverloadMasterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DestinyLoCItemGroup.tab))
				.setRegistryName("overload_master_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 50;
			setNoAI(false);
			setCustomName(new StringTextComponent("[Lv150] OVERLOAD CHAMPION"));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Overload_damageProcedure.executeProcedure(Stream
		...
		public void onDeath(DamageSource source) {
			...
			Death_OverloadProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Spawn_OverloadProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			return retval;
