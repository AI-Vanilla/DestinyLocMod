...
import net.destiny.destinyloc.procedures.VanillaEssenceExoenteiteigasuponsitaShiProcedure;
import net.destiny.destinyloc.procedures.VanillaEssenceExo1enteiteigaSiWangsitaShiProcedure;
import net.destiny.destinyloc.itemgroup.DestinyLoCItemGroup;
import net.destiny.destinyloc.entity.renderer.VanillaEssenceExoRenderer;
...
public class VanillaEssenceExoEntity extends DestinyLocModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.1f, 2.6f)).build("vanilla_essence_exo").setRegistryName("vanilla_essence_exo");
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DestinyLoCItemGroup.tab))
				.setRegistryName("vanilla_essence_exo_spawn_egg"));
	}
