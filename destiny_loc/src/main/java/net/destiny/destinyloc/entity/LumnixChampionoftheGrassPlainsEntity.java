...
import net.destiny.destinyloc.procedures.LumnixChampionoftheGrassPlainsenteiteigasuponsitaShiProcedure;
import net.destiny.destinyloc.procedures.LumnixChampionoftheGrassPlainsenteiteigaSiWangsitaShiProcedure;
import net.destiny.destinyloc.itemgroup.DestinyLoCItemGroup;
import net.destiny.destinyloc.item.LegendaryEngramItem;
import net.destiny.destinyloc.entity.renderer.LumnixChampionoftheGrassPlainsRenderer;
...
public class LumnixChampionoftheGrassPlainsEntity extends DestinyLocModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DestinyLoCItemGroup.tab))
				.setRegistryName("lumnix_championofthe_grass_plains_spawn_egg"));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 250;
			setNoAI(false);
			setCustomName(new StringTextComponent("[Lv80] LUMNIX, CHAMPION OF THE PLAINS"));
			setCustomNameVisible(true);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Blocks.GRASS));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Blocks.GRASS));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(LegendaryEngramItem.block));
		}
