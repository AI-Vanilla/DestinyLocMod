...
public class VanillaEssenceExo1enteiteigasuponsitaShiProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				DestinyLocMod.LOGGER.warn("Failed to load dependency world for procedure VanillaEssenceExo1enteiteigasuponsitaShi!");
			return;
		}
