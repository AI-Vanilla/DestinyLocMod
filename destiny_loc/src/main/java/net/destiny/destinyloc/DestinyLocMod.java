 ...
 *
 *    Keep the DestinyLocModElements object in this class and all calls to this object
...
@Mod("destiny_loc")
public class DestinyLocMod {
	public static final Logger LOGGER = LogManager.getLogger(DestinyLocMod.class);
	...
	public DestinyLocMod() {
		...
		MinecraftForge.EVENT_BUS.register(new DestinyLocModFMLBusEvents(this));
	}
